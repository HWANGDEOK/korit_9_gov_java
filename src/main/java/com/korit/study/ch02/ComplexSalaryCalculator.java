...
public class ComplexSalaryCalculator {
    public static void main(String[] args) {
        ...
        int overtimePayment = isOverTime ? 100000 + ((overtimeHours-10) * 15000) : overtimeHours * 10000;
        ...
        double taxRate = totalSalary > 5000000 ? 0.15 : 0.1;
