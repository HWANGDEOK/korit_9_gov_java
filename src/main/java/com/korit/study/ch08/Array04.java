...
public class Array04 {
    public static String[] names = new String[] {"김일", "김이", "김삼", "김사", "김오", "김육", "김칠", "김팔", "김구"};

    public static void main(String[] args) {
        // 추가(Create), 조희(Read), 수정(Update), 삭제(Delete) => CRUD
    ...
    public static void showNameList() {
        ...
        while (true) {
            ...
            if (selectedPage == 0) {
                ...
                String[] nameOfPagination = pagination(selectedPage, size);
                for (int i = 0; i < nameOfPagination.length; i++) {
                    System.out.printf("%d.%s\n", i + 1, nameOfPagination[i]);
                }
                System.out.println();
            }
        }
